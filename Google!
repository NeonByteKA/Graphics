/**
 * This program's lucky subscriber is Chester Banks look at this awesome programmer's projects here:
 * https://www.khanacademy.org/profile/chesterbanks/projects
...
var emaile = "martin.brinkmann@googlemail.com";
var firstLetter = "M";
...
var signInBox = function() {
    ...
    fill(255);
    ellipse(305, 205, 55, 55);
    rect(265, 250, 80, 30);
    arc(305, 250, 80, 30, 180, 360);
    arc(305, 280, 80, 29, 360, 540);
...
var gMail = function(x, y, s) {
    ...
    rect(304, 584, 23, 10);
    triangle(304, 576, 305, 585, 320, 585);
